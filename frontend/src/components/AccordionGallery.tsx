      ...
      {items.map((item, i) => {
        ...
        return (
          <Tag
            ...
            className="group relative block min-h-0 min-w-0 flex-[1_1_0] cursor-pointer overflow-hidden bg-[#0a0713] no-underline outline-none [transform-origin:center] [transform-style:preserve-3d] [box-shadow:0_10px_30px_-18px_rgba(0,0,0,0.8)] focus-visible:[box-shadow:0_0_0_2px_var(--ag-accent),0_10px_30px_-18px_rgba(0,0,0,0.8)] max-[520px]:min-h-[84px] max-[520px]:!transform-none"
            style={
              {
          ...
          >
            <span
              ...
              className="absolute top-1/2 left-1/2 h-full w-[var(--ag-media-size,320px)] -translate-x-1/2 -translate-y-1/2 [filter:grayscale(var(--ag-gray,0.35))]"
              style={{
            ...
            >
              <SafeImage
                ...
                draggable={false}
                className="pointer-events-none block h-full w-full max-w-none select-none object-cover [-webkit-user-drag:none]"
