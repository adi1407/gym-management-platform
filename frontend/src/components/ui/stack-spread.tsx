...
const IMG = {
  plane:
    "https://images.unsplash.com/photo-1474302770733-aca57fa8469e?w=800&q=80",
  painting:
  ...
  meadow:
    "https://images.unsplash.com/photo-1499002238440-d349b9540ea8?w=800&q=80",
  stripes:
...
const SUB =
  "Digital products, interfaces, and experiences built around people.";
  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          <h2
            className="w-full whitespace-pre-line font-[family-name:var(--font-display)] text-[4.5vw] font-normal leading-none! tracking-tight max-md:text-[10vw]"
